...
const DICT = {
  fr: {
    ...
    'topbar.fit': 'Ajuster',
    'topbar.fitTitle': 'Ajuster la vue (Ctrl+Meta+F)',
    ...
    'tool.move': 'Déplacer / sélectionner (Ctrl+Meta+V)',
    'tool.reveal': 'Révéler le brouillard (Ctrl+Meta+R)',
    'tool.hide': 'Re-cacher le brouillard (Ctrl+Meta+H)',
    'tool.token': 'Poser un token (Ctrl+Meta+T)',
    'tool.grid': 'Déplacer / redimensionner la grille',
    'tool.ruler': 'Règle de mesure (Ctrl+Meta+M)',
    'tool.frame': 'Cadrage de la vue joueurs',
    'tool.config': 'Réglages de la grille (Ctrl+Meta+G)',
    ...
    'combat.next': 'Combattant suivant (Ctrl+Meta+N)',
    ...
    'ruler.hint': 'Glisse sur la carte pour mesurer. Ctrl+Meta+M ou Échap pour quitter.',
    'ruler.cells': 'cases',
  ...
  en: {
    ...
    'topbar.fit': 'Fit',
    'topbar.fitTitle': 'Fit view to map (Ctrl+Meta+F)',
    ...
    'tool.move': 'Move / select (Ctrl+Meta+V)',
    'tool.reveal': 'Reveal fog (Ctrl+Meta+R)',
    'tool.hide': 'Re-hide fog (Ctrl+Meta+H)',
    'tool.token': 'Place a token (Ctrl+Meta+T)',
    'tool.grid': 'Move / resize the grid',
    'tool.ruler': 'Measuring ruler (Ctrl+Meta+M)',
    'tool.frame': 'Player view framing',
    'tool.config': 'Grid settings (Ctrl+Meta+G)',
    ...
    'combat.next': 'Next combatant (Ctrl+Meta+N)',
    ...
    'ruler.hint': 'Drag on the map to measure. Ctrl+Meta+M or Esc to exit.',
    'ruler.cells': 'cells',
  ...
  es: {
    ...
    'topbar.fit': 'Ajustar',
    'topbar.fitTitle': 'Ajustar la vista al mapa (Ctrl+Meta+F)',
    ...
    'tool.move': 'Mover / seleccionar (Ctrl+Meta+V)',
    'tool.reveal': 'Revelar la niebla (Ctrl+Meta+R)',
    'tool.hide': 'Volver a ocultar la niebla (Ctrl+Meta+H)',
    'tool.token': 'Colocar un token (Ctrl+Meta+T)',
    'tool.grid': 'Mover / redimensionar la rejilla',
    'tool.ruler': 'Regla de medición (Ctrl+Meta+M)',
    'tool.frame': 'Encuadre de la vista de jugadores',
    'tool.config': 'Ajustes de la rejilla (Ctrl+Meta+G)',
    ...
    'combat.next': 'Siguiente combatiente (Ctrl+Meta+N)',
    ...
    'ruler.hint': 'Arrastra sobre el mapa para medir. Ctrl+Meta+M o Esc para salir.',
