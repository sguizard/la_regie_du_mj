...
const DICT = {
  fr: {
    ...
    'topbar.fit': 'Ajuster',
    'topbar.fitTitle': 'Ajuster la vue (Ctrl+Alt+F)',
    ...
    'tokens.addDef': '+ DEF',
    'tokens.addDefTitle': 'Définir la défense (CA)',
    'tokens.defTitle': 'Défense (CA)',
    'tokens.defPrompt': 'Valeur de DEF ?',
    'tokens.atkTitle': "Bonus d'attaque",
    'tokens.dmTitle': 'Dégâts (ex. 1d8 + 3)',
    'tokens.addType': '+ type',
    ...
    'tool.move': 'Déplacer / sélectionner (Ctrl+Alt+V)',
    'tool.reveal': 'Révéler le brouillard (Ctrl+Alt+R)',
    'tool.hide': 'Re-cacher le brouillard (Ctrl+Alt+H)',
    'tool.token': 'Poser un token (Ctrl+Alt+T)',
    'tool.grid': 'Déplacer / redimensionner la grille',
    'tool.ruler': 'Règle de mesure (Ctrl+Alt+M)',
    'tool.frame': 'Cadrage de la vue joueurs',
    'tool.config': 'Réglages de la grille (Ctrl+Alt+G)',
    'tool.notes': 'Notes du MJ pour cette carte (Ctrl+Alt+B)',
    ...
    'notes.empty': "Aucune note pour cette carte. « + Nouvelle note » pour commencer.",
    'notes.titlePlaceholder': 'Titre de la note',
    'notes.bodyPlaceholder': "Rien n'est transmis aux joueurs.",
    ...
    'frame.toView': '🎯 Ma vue',
    'frame.toViewTitle': 'Cadrer les joueurs sur la portion de carte actuellement visible',
    'frame.full': '🗺 Toute la carte',
    'frame.hint': 'Trace le rectangle que verront les joueurs (ou « Ma vue »).',
    ...
    'props.template': 'Modèle',
    'props.deleteTemplate': 'Supprimer le modèle',
    ...
    'templates.editTitle': 'Modifier ce modèle',
    ...
    'combat.next': 'Combattant suivant (Ctrl+Alt+N)',
    ...
    'ruler.hint': 'Glisse sur la carte pour mesurer. Ctrl+Alt+M ou Échap pour quitter.',
    'ruler.cells': 'cases',
  ...
  en: {
    ...
    'topbar.fit': 'Fit',
    'topbar.fitTitle': 'Fit view to map (Ctrl+Alt+F)',
    ...
    'tokens.initPrompt': 'Initiative?',
    'tokens.addDef': '+ DEF',
    'tokens.addDefTitle': 'Set the defence (AC)',
    'tokens.defTitle': 'Defence (AC)',
    'tokens.defPrompt': 'DEF value?',
    'tokens.atkTitle': 'Attack bonus',
    'tokens.dmTitle': 'Damage (e.g. 1d8 + 3)',
    'tokens.addType': '+ type',
    ...
    'tool.move': 'Move / select (Ctrl+Alt+V)',
    'tool.reveal': 'Reveal fog (Ctrl+Alt+R)',
    'tool.hide': 'Re-hide fog (Ctrl+Alt+H)',
    'tool.token': 'Place a token (Ctrl+Alt+T)',
    'tool.grid': 'Move / resize the grid',
    'tool.ruler': 'Measuring ruler (Ctrl+Alt+M)',
    'tool.frame': 'Player view framing',
    'tool.config': 'Grid settings (Ctrl+Alt+G)',
    'tool.notes': 'GM notes for this map (Ctrl+Alt+B)',
    ...
    'notes.title': 'Notes',
    'notes.add': '+ New note',
    'notes.empty': 'No note for this map yet. Use "+ New note" to start one.',
    'notes.titlePlaceholder': 'Note title',
    'notes.bodyPlaceholder': 'Nothing here is sent to the players.',
    ...
    'frame.toView': '🎯 My view',
    'frame.toViewTitle': 'Frame the players on the currently visible portion of the map',
    'frame.full': '🗺 Whole map',
    'frame.hint': 'Draw the rectangle the players will see (or "My view").',
    ...
    'props.deleteTemplate': 'Delete the template',
    ...
    'templates.editTitle': 'Edit this template',
    ...
    'combat.next': 'Next combatant (Ctrl+Alt+N)',
    ...
    'ruler.hint': 'Drag on the map to measure. Ctrl+Alt+M or Esc to exit.',
    'ruler.cells': 'cells',
  ...
  es: {
    ...
    'topbar.fit': 'Ajustar',
    'topbar.fitTitle': 'Ajustar la vista al mapa (Ctrl+Alt+F)',
    ...
    'tokens.addDef': '+ DEF',
    'tokens.addDefTitle': 'Definir la defensa (CA)',
    'tokens.defTitle': 'Defensa (CA)',
    'tokens.defPrompt': '¿Valor de DEF?',
    'tokens.atkTitle': 'Bonificación de ataque',
    'tokens.dmTitle': 'Daño (p. ej. 1d8 + 3)',
    'tokens.addType': '+ tipo',
    ...
    'tool.move': 'Mover / seleccionar (Ctrl+Alt+V)',
    'tool.reveal': 'Revelar la niebla (Ctrl+Alt+R)',
    'tool.hide': 'Volver a ocultar la niebla (Ctrl+Alt+H)',
    'tool.token': 'Colocar un token (Ctrl+Alt+T)',
    'tool.grid': 'Mover / redimensionar la rejilla',
    'tool.ruler': 'Regla de medición (Ctrl+Alt+M)',
    'tool.frame': 'Encuadre de la vista de jugadores',
    'tool.config': 'Ajustes de la rejilla (Ctrl+Alt+G)',
    'tool.notes': 'Notas del DJ para este mapa (Ctrl+Alt+B)',
    ...
    'notes.empty': 'Ninguna nota para este mapa. Usa «+ Nueva nota» para empezar.',
    'notes.titlePlaceholder': 'Título de la nota',
    'notes.bodyPlaceholder': 'Nada de esto se envía a los jugadores.',
    ...
    'frame.toView': '🎯 Mi vista',
    'frame.toViewTitle': 'Encuadrar a los jugadores en la parte del mapa actualmente visible',
    'frame.full': '🗺 Todo el mapa',
    'frame.hint': 'Traza el rectángulo que verán los jugadores (o «Mi vista»).',
    ...
    'props.def': 'DEF',
    'props.atk': 'ATK (bonificación de ataque)',
    'props.dm': 'DM (daño)',
    'props.color': 'Color',
    'props.size': 'Tamaño',
    ...
    'props.template': 'Plantilla',
    'props.deleteTemplate': 'Eliminar la plantilla',
    ...
    'templates.editTitle': 'Editar esta plantilla',
    ...
    'combat.next': 'Siguiente combatiente (Ctrl+Alt+N)',
    ...
    'ruler.hint': 'Arrastra sobre el mapa para medir. Ctrl+Alt+M o Esc para salir.',
