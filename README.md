...
4. **Tokens** — la barre latérale gauche affiche, sous les cartes, la **liste des
   ...
   **pastille / vignette** ouvre un menu pour choisir une image (bibliothèque ou
   ...
   Ligne 3 (seulement si l'un des deux est renseigné) : **ATK** (bonus d'attaque, texte
   libre : `+4`, ou `+4 / +6` pour une attaque multiple) et **DM** (dégâts en notation de dés — `2d6`, `1d8 + 3`), tous deux
